...
export const projects: Project[] = [
  {
    slug: 'bold-brand-revamp',
    client: 'Aura Beauty',
    name: 'Bold Brand Revamp',
    date: '2023',
    imageId: 'project-1',
  ...
  {
    slug: 'viral-voyage-campaign',
    client: 'Nomad Nook',
    name: 'Viral Voyage Campaign',
    date: '2023',
    imageId: 'project-2',
  ...
  {
    slug: 'eco-growth-strategy',
    client: 'GreenLeaf Organics',
    name: 'Eco-Growth Strategy',
    date: '2022',
    imageId: 'project-3',
  ...
  {
    slug: 'future-forward-launch',
    client: 'TechSphere Inc.',
    name: 'Future-Forward Launch',
    date: '2022',
    imageId: 'project-4',
